...
var (
	techDetails = []techDetail{
		...
		{"Pre-Stellar", "At TL 8, it is possible to reach other worlds in the same system, although terraforming or full colonisation are not within reach."},
		...
		{"High Stellar", "Black globe generators suggest a new direction for defensive technologies, while the development of synthetic anagathics means that the human lifespan is now vastly increased. Higher Technology Levels exist and may appear in other settings or be discovered by pioneering scientists."},
		{"High Stellar", "Antimatter engines allow much longer jumps (J-8) with reasonable cargo, counter weapons and shields improve, powered/active armor increases durability, communications equivalent to personal telepathy and good shielding"},
		{"Low Sector", "All engines are compact, take fewer engineers, and perform extremely well, up to J-12 and M-16, P-18, human multiplicity physically and virtually is common, super-intelligent AI, low berths are 0 risk and cure most cancers and diseases, forms are mutable."},
		{"Average Sector", "Speculative, J-16, M-20, P-24, extremely good armor, black globe with complete variability control and huge storage, cvapital ships can use black globes to power outrageous arsenals."},
		{"High Sector", "J-20, J-30 when not near massive objects, J-40 with obscure psionics integrated into production and operation of engines and ships. Resurections, backups, robo/physical/virtual multi-embodiement with merged consciousness, meta-human groupings with others for even larger merged consciousnesses. Immunity to pretty much every form of death."},
	}
)
